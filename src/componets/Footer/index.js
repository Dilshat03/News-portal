...
const Footer = () => {
    return (
        <div>
            <footer className="bg-green-700 dark:bg-gray-800 pt-2   pb-5 xl:pt-6">
                <div
                    ...
                    <div className="pt-8 flex border-t border-gray-200 max-w-xs mx-auto items-center justify-between">
                        <Link to="#">
                            <svg width="20" height="20" fill="currentColor"
                                 className="text-xl hover:text-pink-500 dark:hover:text-white text-yellow-200 duration-200"
